...
<template>
  <div
    class="table-sticky-scroller"
    style="width: 400px; height: 600px; overflow: auto"
  >
    <div class="table-sticky-content" style="width: 100%; height: 1200px; padding-left: 100px;">
      <el-table
        :data="tableData"
        show-sticker
        sticker-wrapper=".table-sticky-scroller"
        style="width: 100%;margin-top: 300px;"
      >
        <el-table-column
          fixed
          prop="date"
  ...
  export default {
    ...
    computed: {
      allSelected: {
        ...
        set(b) {
          this.tableData.forEach((item) => (item.selected = b));
        },
      },
    },
    methods: {
      handleCurrentChange(n) {
        this.currentPage = n;
        this.tableData = n == 1 ? page1data : page2data;  // 需要缓存每一列的选择状态
      },
    },
  };
</script>
...
:::demo 使用 wrapper-move-filters 属性过滤内部禁止出发 wrapper-move 的 handler

```html
<template>
  <el-table :data="tableData" height="300px" wrapper-move :wrapper-move-filters="wrapperMoveFilters" :cell-class-name="cellClassName" style="width: 100%">
    <el-table-column type="index" :index="indexMethod"> </el-table-column>
    <el-table-column prop="date" label="日期" width="180"> </el-table-column>
    <el-table-column prop="name" label="姓名" width="180"> </el-table-column>
    <el-table-column prop="address" label="地址"> </el-table-column>
  ...
  export default {
    ...
    methods: {
      cellClassName(data) {
        ...
        return `cell--column-${columnIndex}`;
      },
      indexMethod(index) {
        return index * 2;
      },
...
| wrapper-move            | 右键滚动                                                                                                                                                                                                    | Boolean                                               | —                              | true                                                        |
| wrapper-move-filters    | 节点 属性过滤,假设 path 中存在此节点数据, type: class, id ,data, attr, button 是 鼠标左右键， 0 表示 name 结合 右键屏蔽 例如：[{type: 'class',name: 'scroll-wrapper-prevent',button: 0 }]                   | Array                                                 | —                              | []                                                          |
| sticky-header           | 粘性头部                                                                                                                                                                                                    | Boolean                                               | —                              | false                                                       |
| sticky-offset           | 粘性头部顶部偏移                                                                                                                                                                                            | Number                                                | —                              | 0                                                           |
| sticky-wrapper          | 粘性头部所属滚动容器，所属滚动容器的 dom 选择器， 如类名 .container                                                                                                                                         | String                                                | —                              | —                                                           |
| sticky-style            | 粘性头部样式                                                                                                                                                                                                | Object                                                | —                              | {}                                                          |
...
| sticker-header | 粘性头部顶部插槽。                                                                                                                    |
| sticker-footer | 粘性头部底部插槽。                                                                                                                    |
